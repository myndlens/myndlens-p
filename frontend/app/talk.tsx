...
const styles = StyleSheet.create({
  ...
  pipelineCard: { backgroundColor: 'rgba(20,20,30,0.65)', borderRadius: 12, paddingVertical: 6, paddingHorizontal: 14, marginBottom: 4, borderWidth: 1, borderColor: '#1E1E2E' },
  pipelineRow: { flexDirection: 'row', alignItems: 'center', minHeight: 20 },
  pipelineDot: { width: 16, height: 16, borderRadius: 8, borderWidth: 1.5, borderColor: '#2A2A3E', alignItems: 'center', justifyContent: 'center', backgroundColor: '#0A0A14' },
  pipelineDotDone: { borderColor: '#00D68F', backgroundColor: '#00D68F22' },
  pipelineDotActive: { borderColor: '#6C63FF', backgroundColor: '#6C63FF22' },
  pipelineCheck: { color: '#00D68F', fontSize: 9, fontWeight: '700' },
  pipelinePulse: { width: 5, height: 5, borderRadius: 3, backgroundColor: '#6C63FF' },
  pipelineNum: { color: '#3A3A4E', fontSize: 8, fontWeight: '600' },
  pipelineLine: { position: 'absolute', left: 7, top: 17, width: 1.5, height: 4, backgroundColor: '#1E1E2E' },
  pipelineLineDone: { backgroundColor: '#00D68F44' },
  pipelineLabel: { color: '#444455', fontSize: 10, marginLeft: 8, flex: 1 },
