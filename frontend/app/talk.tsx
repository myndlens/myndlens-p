...
const styles = StyleSheet.create({
  ...
  pipelineCard: { backgroundColor: 'rgba(20, 20, 34, 0.75)', borderRadius: 16, paddingVertical: 16, paddingHorizontal: 20, marginHorizontal: 4, marginBottom: 8, borderWidth: 1, borderColor: '#1E1E2E' },
  pipelineCardIdle: { borderColor: '#1A1A28' },
  pipelineIdleInner: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 10 },
  pipelineReadyDot: { width: 8, height: 8, borderRadius: 4, backgroundColor: '#00D68F' },
  pipelineIdleText: { color: '#555568', fontSize: 14 },
  pipelineActiveInner: { flexDirection: 'row', alignItems: 'center', gap: 14 },
  pipelineTextBlock: { flex: 1 },
  pipelineActiveText: { color: '#E0E0F0', fontSize: 15, fontWeight: '600' },
  pipelineStepNum: { color: '#555568', fontSize: 12, marginTop: 3 },
  pipelineBarBg: { height: 3, backgroundColor: '#1A1A28', borderRadius: 2, marginTop: 12, overflow: 'hidden' },
